      ...
      <div>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="flex gap-2 p-1 px-3 bg-red-500 rounded-full text-white hover:scale-105 transition-all cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <button className="flex gap-2 p-1 px-3 bg-red-500 rounded-full text-white hover:scale-105 transition-all cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
